...
export default function Profil({ setIsCopy }) {
  ...
  const handleBoxClick1 = (e) => {
    setOpenBox1(!openBox1);
    setOpenBox2(false);
    setOpenBox3(false);
    setOpenBox4(false);
  };
  const handleBoxClick2 = (e) => {
    setOpenBox1(false);
    setOpenBox2(!openBox2);
    setOpenBox3(false);
    setOpenBox4(false);
  };
  const handleBoxClick3 = (e) => {
    setOpenBox1(false);
    setOpenBox2(false);
    setOpenBox3(!openBox3);
    setOpenBox4(false);
  };
  const handleBoxClick4 = (e) => {
    setOpenBox1(false);
    setOpenBox2(false);
    setOpenBox3(false);
  ...
  return (
    <div className="h-screen w-full flex p-8 relative text-gray-950 dark:text-slate-100">
      ...
      <div className="h-full w-2/3  flex flex-col items-center justify-start px-32 py-16 ">
            ...
            <div className="w-full">
              ...
              {openBox1 && (
                <div className={`${textBox}`}>
                  ...
                  <span className="font-extrabold">Rémi Caron</span>, j'ai 32
                  ans et je viens de valider avec succès mon diplôme de
                  développeur d'applications web et mobile avancées, une
                  formation enrichissante que j'ai suivie avec brio à la{" "}
                  <span className="font-extrabold">"Wild Code School"</span>, où
                  j'ai été chaleureusement félicité par le jury. <br />
                </div>
              )}
            </div>
            <div className="w-full">
              ...
              {openBox2 && (
                <div className={`${textBox}`} id="box-2">
                  <span className="ml-20"></span>Durant ces deux années de
                  formation, j'ai eu la chance de participer à divers projets,
                  que ce soit au sein de l'école ou en entreprise pendant mon
                  alternance. Mon expertise s'est principalement focalisée sur{" "}
                  <span className="font-extrabold">React</span> en front-end,
                  que j'ai su associer à{" "}
                  <span className="font-extrabold">Tailwind</span>, dont je
                  maîtrise désormais toutes les subtilités. En ce qui concerne
                  le back-end, j'ai travaillé avec
                  <span className="font-extrabold"> Node/Express</span> en
                  utilisant <span className="font-extrabold">Prisma</span> avec{" "}
                  <span className="font-extrabold">GraphQL</span>, et bien sûr,
                  j'ai réalisé tous ces projets avec{" "}
                  <span className="font-extrabold">TypeScript</span> pour une
                  meilleure sécurité et efficacité. J'ai également eu l'occasion
                  de coder des projets en{" "}
                  <span className="font-extrabold">Next.js</span>, ainsi que des
                  applications complètes en{" "}
                  <span className="font-extrabold">
                    MERN (MongoDB, Express, React, Node.js)
                  </span>
                  . Durant mon alternance, j'ai même eu l'opportunité de
                  travailler sur un projet avec{" "}
                  <span className="font-extrabold">WordPress</span>
                  , ce qui m'a permis d'élargir mes compétences et de
                  diversifier mes connaissances dans le domaine du
                  développement. <br />{" "}
                </div>
              )}
            </div>
            <div className="w-full">
              ...
              {openBox3 && (
                <div className={`${textBox}`} id="box-3">
                  <span className="ml-20"></span>En parallèle de mon
                  apprentissage en développement, j'ai également acquis une
                  solide maîtrise de{" "}
                  <span className="font-extrabold">Figma</span>, grâce à la
                  création de plusieurs designs de site pour l'entreprise dans
                  laquelle j'étais alternant, ainsi que pour un projet de cours.
                  De plus, je suis actuellement en train de me former sur{" "}
                  <span className="font-bold">Blender</span> en association avec{" "}
                  <span className="font-bold">Three.js</span>, ouvrant ainsi de
                  nouvelles perspectives passionnantes dans le monde de la 3D.{" "}
                  <br />
                </div>
              )}
            </div>
            <div className="w-full">
              ...
              {openBox4 && (
                <div className={`${textBox}`} id="box-4">
                  ...
                  expériences et compétences, je suis animé par une forte
                  volonté d'apprendre et de progresser davantage dans le domaine
                  qui me passionne tant. Je suis donc à la recherche de mon
                  premier emploi dans la tech, motivé et déterminé à mettre en
                  pratique mes connaissances tout en continuant à enrichir mon
                  savoir-faire.
                </div>
              )}
            </div>
